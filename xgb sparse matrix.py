# -*- coding: utf-8 -*-
"""
Created on Mon Sep  5 16:01:28 2016
...
def act_data_treatment(dsname):
    ...
    ##how about week number ?like 1234567
    dataset = dataset.drop('date', axis = 1)
    
    return dataset
##for unique entries substitution
...
##dataset processing
act_train_data=pd.read_csv(r"D:\python\red hat\dataset\act_train.csv",dtype={'people_id':np.str,'activity_id':np.str,'outcome':np.int8},parse_dates=['date'])
act_test_data= pd.read_csv(r"D:\python\red hat\dataset\act_test.csv", dtype={'people_id': np.str, 'activity_id': np.str}, parse_dates=['date'])
people_data= pd.read_csv(r"D:\python\red hat\dataset\people.csv", dtype={'people_id': np.str, 'activity_id': np.str, 'char_38': np.int32}, parse_dates=['date'])
...
##include all the features in a variable
